...
export default function Services() {
    ...
    return (
        <section ref={sectionRef} className="py-16 md:py-30 px-6 md:px-20 bg-background relative overflow-hidden">
            {/* Ambient Background */}
            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-20 text-center max-w-2xl mx-auto">
                    <h2 className="text-sm font-medium uppercase tracking-[0.2em] text-primary mb-4">{t("services.title")}</h2>
                    <h3 className="text-4xl md:text-5xl font-heading font-bold mb-6">
                        {t("services.heading1")} <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-purple-500">{t("services.heading2")}</span>
                    </h3>
                        ...
                        >
                            ...
                            <div className="absolute inset-0 p-6 flex flex-col justify-end">
                                <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                                    <h3 className="text-2xl font-bold text-white mb-3">{t(`services.items.${service.id}.title`)}</h3>
